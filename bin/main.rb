...
while TBot
  ...
  TBot.do_retweet(  # Here you can set what you are looking for retweet: Strings will provide the search while the Integer will provide de number of retweets
